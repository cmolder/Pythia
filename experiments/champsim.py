...
def run_command():
    ...
    cmd = '{binary} --config={config} --warmup_instructions={warm}000000 --simulation_instructions={sim}000000 {cloudsuite_knobs} {llc_pref_knobs} -traces {trace} > {results}/{results_file} 2>&1'.format(
        binary=binary,
