#ifndef SCOOBY_DOUBLE_H
#define SCOOBY_DOUBLE_H
...
class ScoobyDouble : public Prefetcher
{
private:
...
private:
	...
	void gen_multi_degree_pref(uint64_t page, uint32_t offset, uint32_t action_index, float action_value, uint32_t pref_degree,
...
public:
	...
	void dump_stats();
	void print_config();
    bool is_high_confidence(uint32_t action_index);
